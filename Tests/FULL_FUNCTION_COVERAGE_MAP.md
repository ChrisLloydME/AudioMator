...
| Metadata exchange and filename tools | Fast and app-hosted tests cover rename templates, collision policy, filename-to-metadata extraction, CSV/delimited parsing, fixture import/export planning, status text, and fixture existence. | `MetadataExchangeTests.swift`, `MetadataExchangeFixtureTests.swift`, `FilenameMetadataTemplateTests.swift`, `FileRenameTemplateTests.swift`, `FileRenameTransactionTests.swift`, `MetadataFilenameStatusPresentationTests.swift` |
